...
class CameraGalleryPackage extends Package {
/*    ^^^^^^^^^^^^^^^
      CHANGE THIS PORTION
...
*/
	...
	protected $pkgHandle = 'camera_gallery';
	protected $appVersionRequired = '5.4.1';
	protected $pkgVersion = '1.4';
	
	public function getPackageName() {
		return t('Camera Gallery');
	}
	
	public function getPackageDescription() {
		return t('Adds Camera Gallery to your concrete5 website.');
	}
