...
class CameraGalleryBlockController extends BlockController {
/*    ^^^^^^^^^^^^^^^
      CHANGE THIS PORTION
...
*/
	...
	protected $btTable = 'btCameraGallery'; //Must be the same as table name in db.xml.
	                                          //Should correspond to block's directory/class name.
	
	public function getBlockTypeName() {
		return t('Camera Gallery'); //Appears in "Add Block" list when adding blocks to a page
	}
	
	public function getBlockTypeDescription() {
		return t('Add Camera Gallery blocks to your site'); //Only appears in dashboard "Add Functionality" page
	}
